...
Lis, dans l'ordre : `README.md`, `templates/docs/WORKFLOW.md`, les dix `templates/.claude/skills/*/SKILL.md` (setup, spec, code, test, research, feedback, support, post, article, newsletter). Comprends **l'intention** avant de proposer.
