...
- **Repo qui a déjà du contenu marketing dispersé** (drafts, brand book, posts publiés ailleurs) : propose une carte de migration dédiée pour `content/` et `knowledge/brand/`. Ne supprime aucun contenu existant sans autorisation explicite.
